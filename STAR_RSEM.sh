...
# STAR mapping / RSEM quantification pipeline from https://github.com/ENCODE-DCC/long-rna-seq-pipeline/blob/master/DAC/STAR_RSEM_prep.sh
...
@CO\tANNID:gencode.GRCh38.annotation.gtf.gz
@CO\tSPIKEID:ENCFF001RTP VN:None' > commentsENCODElong.txt
...
RSEMparRun=" -p $nThreadsRSEM --ci-memory $trBAMsortRAM "
